...
router.delete("/auth/customer/delete",AuthCustomerController.deleteCustomer); 
...
router.delete("/auth/employee/delete",EmployeeController.deleteEmployee); 
...
router.delete("/productType/delete",ProductTypeController.deleteType); 
...
router.get("/sale/getAll",SaleProductController.getSaleDetails); 
